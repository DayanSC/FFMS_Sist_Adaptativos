...
def aco_algorithm(strings, threshold, max_time, num_ants, num_iterations, alpha, beta, evaporation_rate):
...
def main():
    ...
    parser.add_argument('-n', '--num_ants', type=int, default=94, help="Number of ants")
    parser.add_argument('-ite', '--iterations', type=int, default=292, help="Number of iterations")
    parser.add_argument('-a', '--alpha', type=float, default= 0.9981, help="Alpha parameter")
    parser.add_argument('-b', '--beta', type=float, default=2.8719, help="Beta parameter")
    parser.add_argument('-e', '--evaporation', type=float, default=0.4946, help="Evaporation rate")
